create database strutsteste;

use strutsteste;

--PROPRIETÁRIO
create table customer(id bigint primary key auto_increment, name varchar (50), age bigint (3),  email varchar(50), telefone varchar (20));

insert into customer values(null, 'hugo', 24, 'hugo@gmail.com', '944184815');

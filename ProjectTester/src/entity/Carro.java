	...
	public int acelera(int ac) {
		if (ac == 1) {
			...
			for (int i = 0; i <= this.VelocidadeMax; i++) {
				...
				if (i == 20) {
					System.out.println("1ª Marcha selecionada...");
				} else if (i == 40) {
					System.out.println("2ª Marcha selecionada...");
				} else if (i == 60) {
					System.out.println("3ª Marcha selecionada...");
				} else if (i == 80) {
					System.out.println("4ª Marcha selecionada...");
				} else if (i == 100) {
					System.out.println("5ª Marcha selecionada...");
				} else if (i == 100) {
					System.out.println("6ª Marcha selecionada...");
				} else if (i == 120) {
					System.out.println("7ª Marcha selecionada...");
				} else if (i == 150) {
					System.out.println("8ª Marcha selecionada...");
				} else if (i == 170) {
					System.out.println("9ª Marcha selecionada...");
				} else if (i == 200) {
					System.out.println("10ª Marcha selecionada...");
				}
